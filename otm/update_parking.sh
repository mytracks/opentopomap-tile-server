...
if [ -f /external-data/parking-update-complete ]; then
    echo "Skipping parking data update: data already updated"
    exit 0
fi

echo "Update parking data"
...
touch /external-data/parking-update-complete
